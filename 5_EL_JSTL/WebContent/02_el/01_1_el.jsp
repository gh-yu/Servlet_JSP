...
<body>
	<form action="<%= request.getContextPath() %>/myEL.do" method="post">
		...
		<h4>당신이 가장 좋아하는 _____은?</h4>
		<span class="user">OOO</span>님이 가장 좋아하는 <span class="item">음료</span>는?
		<input type="text" name="baverage"><br>
		
		<span class="user">OOO</span>님이 가장 좋아하는 <span class="item">물건1</span>는?
		<input type="text" name="product"><br>
				
		<span class="user">OOO</span>님이 가장 좋아하는 <span class="item">물건2</span>는?
		<input type="text" name="product"><br>
		
		<span class="user">OOO</span>님이 가장 좋아하는 <span class="item">물건3</span>는?
		<input type="text" name="product"><br>
		
		<span class="user">OOO</span>님이 가장 좋아하는 <span class="item">책</span>는?
